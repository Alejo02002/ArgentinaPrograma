...
public class Monotributo {
	...
	public static void categoriaMonotributo(double ingreso, int superficie, int energia) {
	...
	public static void main(String[] args) {
	  double ingreso = 500000; // en $
	  int superficie = 0;  // en m2
	  int energia = 330; // en KW
	  	  
	  categoriaMonotributo(ingreso, superficie, energia);
